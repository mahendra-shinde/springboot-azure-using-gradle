...
public class ServiceBusIntegrationDemoApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(ServiceBusIntegrationDemoApplication.class, args);
	}
	...
	// NOTE: Please be noted that below are the minimum code for demonstrating the
	// usage of autowired clients.
